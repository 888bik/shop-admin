<template>
  <el-card shadow="never" class="border-0">
    <!-- 新增|刷新 -->
    <ListHeader @add="openAdd" @refresh="getTableData" />
...
} from "@/services/modules/user-level";
...
const {
  ...
  listApi: (page, limit) => getUserLevelList(page, limit),
  deleteApi: deleteUserLevel,
  updateStatusApi: updateUserLevelStatus,
  pageSize: 10,
  initialQuery: {},
});
const {
  ...
  {
    name: [{ required: true, message: "会员等级名称不能为空" }],
  },
  {
    name: "",
    level: 100,
