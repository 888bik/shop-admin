...
export const goodsSkusRequest = new MyRequest({
  baseURL: BASE_URL,
  timeout: TIMEOUT,
});

export const ordersRequest = new MyRequest({
  baseURL: BASE_URL,
  timeout: TIMEOUT,
});

export const expressRequest = new MyRequest({
  baseURL: BASE_URL,
  timeout: TIMEOUT,
});

export const commentsRequest = new MyRequest({
  baseURL: BASE_URL,
  timeout: TIMEOUT,
});

export const userLevelRequest = new MyRequest({
  baseURL: BASE_URL,
  timeout: TIMEOUT,
});
